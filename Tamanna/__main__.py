...
from Tamanna.plugins.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Tamanna.plugins." + module_name)
...
def main():
    ...
    LOGGER.info("Tamanna is starting >> Using long polling.")
